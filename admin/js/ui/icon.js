...
var PATHS = {
  ...
  /* بدّال الثيم — الأيقونة تبيّن الوضع اللي غادي تروح ليه، ماشي اللي
     راك فيه (شمس = "ولّي نهاري"). زوجهم موجودين في نفس اللحظة وCSS
     يخبّي واحد حسب [data-theme] — بلا هذا الضغطة تحتاج إعادة بناء
     الشاسي كامل باش تبدّل الأيقونة. */
