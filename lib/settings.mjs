...
const DEFAULTS = {
  ...
  /* بيكسل تيك توك تاع الصفحة الرئيسية. فارغ = نستعملو TIKTOK_PIXEL_ID
     (ولا الافتراضي المكتوب في lib/tiktok.mjs). يتبدّل من اللوحة، بلا
     نشر — علاش هو هنا وماشي في متغيّر بيئة برك. */
  tiktokPixelMain: '',
...
export async function saveSettings(patch) {
  ...
  const next = {
    ...
    /* id مكسّر (الكود كامل ملصوق مثلاً) يتخزّن فارغ ماشي كيما هو —
       وإلا يخرج في كل صفحة داخل وسم `<script>` */
    ...(patch.tiktokPixelMain === undefined
      ? {} : { tiktokPixelMain: sanitizePixelId(patch.tiktokPixelMain) }),
