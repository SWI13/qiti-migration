...
const DEFAULT_PIXEL_ID = 'DA3ONQBC77U8CMLK4K8G';
...
/**
 * id تاع البيكسل المستعمل دروك، ولا '' إذا كان مطفي.
 *
...
export function tiktokPixelId() {
  ...
  const id = raw === undefined ? DEFAULT_PIXEL_ID : raw.trim();
 ...
 */
export function tiktokPixelSnippet(id = tiktokPixelId()) {
  if (!id) return '';
 ...
 */
export async function sendTikTokEvent(eventName, order, { value } = {}) {
