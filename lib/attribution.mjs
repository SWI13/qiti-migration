...
export const ATTRIBUTION_FIELDS = [
  ...
  'fbclid', 'ttclid',
  /* `_ttp` — كوكي يحطّها بيكسل تيك توك في المتصفّح ويبعثها main.js مع
     الطلب. مفتاح مطابقة للـ Events API، ماشي دليل على نقرة إعلان:
     channelKey() تحت ما تحسبهاش، وإلا كل زائر يولّي "تيك توك". */
  'ttp',
];
...
export function channelLabel(attribution) {
  if (!attribution) return 'زيارة مباشرة / غير معروف';
