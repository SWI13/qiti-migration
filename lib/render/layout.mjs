...
import { tiktokPixelSnippet } from '../tiktok.mjs';
...
export function renderPage({
  ...
  themed = true,
  track = null,
  /* معاينة اللوحة: نفس الصفحة بالضبط، بصح بلا بيكسل. بلا هذا، كل مرّة
     تحلّ فيها المحرّر تبعث زيارة كاذبة لتيك توك ونسبة التحويل تطيح. */
  preview = false,
  /* id البيكسل تاع هذه الصفحة — يتقرّر في render.mjs (بيكسل الصفحة
     ولا تاع الرئيسية)، ماشي هنا: الغلاف يرسم برك، ما يقراش الإعدادات. */
  pixelId = '',
}) {
...
${preview ? '' : tiktokPixelSnippet(pixelId)}
</head>
<body>
