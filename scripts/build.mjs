 ...
 * بناء مجلّد النشر.
 *
 * ⚠️ علاش هذا موجود: كان publish = "." — يعني Netlify كان ينشر جذر
 * المستودع كامل. أي واحد كان يقدر يفتح:
 *
 *     /netlify/lib/catalog.mjs   → مفاتيح التخزين وكل منطق الكاتالوغ
 *     /netlify/lib/auth.mjs      → طريقة توقيع الكوكي
 *     /package.json, /README.md  → …
 *
 * الفنكشنات تتبني وحدها من netlify/functions/، فماشي لازم يكونو في
 * مجلّد النشر أصلاً. هنا ننسخو غير اللي الزائر محتاجو.
 *
